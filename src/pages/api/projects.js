...
const projectsData = [
  {
      id: 1,
      title: "Chalets et Caviar, agence immobilière",
  ...
  {
      id: 2,
      title: "Jupanaos, un blog professionnel",
      description: "Ce site est mon blog professionnel. J'ai conçu un design personnel auquel j'ai implémenté une interface d'administration pour gérer les articles que je poste et les commentaires d'utilisateurs inscrits. Un formulaire de contact est aussi présent.",
  ...
  {
    id: 3,
    title: "Snowtricks, un site communautaire",
...
{
  id: 4,
  title: "BileMo, une entreprise B2B",
...
{
  id: 5,
  title: "To Do & Co, une application de to do",
...
{
  id: 6,
  title: "julie-pariona.fr, portfolio",
  description: "Audit et refactorisation d'une app en Symfony 5",
